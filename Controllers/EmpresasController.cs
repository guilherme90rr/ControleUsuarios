...
namespace CRUDLogin.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idEmpresa,nomeEmpresa,documentoEmpresa,dataCriacao")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idEmpresa,nomeEmpresa,documentoEmpresa,dataCriacao")] Empresa empresa)
        {
